...
```{r results='asis'}
renderTable("https://raw.githubusercontent.com/liao961120/getable/master/inst/rmarkdown/templates/tablefromweb/skeleton/data/df.json")
```
...
renderTable(
  from_repo(
    ...
    repo = "getable", 
    branch = "master",
    path = "inst/rmarkdown/templates/tablefromweb/skeleton/data/df.json")
)
```
